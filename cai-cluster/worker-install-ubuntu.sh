...
startsecs=10
stopsignal=KILL
logfile = /raid1/supervisorlogs/program:cai_kibanaEnricher.log
logfile_maxbytes = 50MB
logfile_backups=1

[program:cai_exportWorker]
command=/usr/bin/python /home/ubuntu/minewhat/workers/workers/exportWorker.py
user=ubuntu
autostart=false
stdout_logfile_maxbytes = 50MB
stdout_logfile_backups = 1
...
startsecs=10
stopsignal=KILL
logfile = /raid1/supervisorlogs/program:cai_exportWorker.log
logfile_maxbytes = 50MB
logfile_backups=1
